        ...
        render={({ state, fullpageApi }) => {
          ...
          <div id="fullpage-wrapper">
              ...
              <div className="section1__footer">
                <main>
                  <div className="section1__short-line short-line__grid1">
                      <NavLink exact to="/kroje" className="section1__link"><p>Wanda</p></NavLink>
                      <p>Kino Wanda</p>
                  </div>
                  <div className="section1__short-line short-line__grid2">
                    <NavLink exact to="/kroje" className="section1__link"><p>Sukiennice</p></NavLink>
                      <p>Rynek Główny</p>
                  </div>
                  <div className="section1__short-line short-line__grid3">
                    <NavLink exact to="/kroje" className="section1__link"><p>Recepcja</p></NavLink>
                      <p>Hotel Forum</p>
                  </div>  
                </main>
              </div>
            ...
            <div className="section fp-auto-height-responsive">
              ...
              <button className="section3__button" onClick={() => {setReadMore(!readMore); rerender()}}>{readMore ? "MNIEJ" : "CZYTAJ WIĘCEJ"}</button>
              <main>
                <animated.div style={growReadMore} className="section3__readMore-text">
                Ultricies tristique nulla aliquet enim tortor at auctor.Feugiat 
                in fermentum posuere urna ristique nulla aliquet, sed do eiusmod tempor incididunt ut 
                labore et dolore magna aliqua.Ultricies tristique nulla aliquet enim tortor at auctor.Feugiat 
                in fermentum posuere urna ristique nulla aliquet, sed do eiusmod tempor incididunt ut 
                labore et dolore magna aliqua.Ultricies tristique nulla aliquet enim tortor at auctor.Feugiat 
                in fermentum posuere urna ristique nulla aliquet, sed do eiusmod tempor incididunt ut 
                labore iquet, sed do eiusmod tempor incididunt ut 
                labore et dolore magna aliqua.Ultricies tristique nulla aliquet enim tortor at auctor.Feugiat 
                in fermentum posuere urna ristique nulla aliquet, sed do eiusmod tempor incididunt ut 
                labore et dolore magna aliqua.Ultricies tristique nulla aliquet enim tortor at auctor.Feugiat 
                in fermentum posuere urna ristique nulla aliquet, sed do eiusmod tempor incididunt ut 
            ...
            <div className="section fp-auto-height">
              <div style={{minHeight: "10em"}}>
                ltricies tristique nulla aliquet enim tortor at auctor.Feugiat 
                in fermentum posuere urna ristique nulla aliquet, sed do eiusmod tempor incididunt ut 
                abore et dolore magna aliqua.Ultricies tristique nulla aliquet enim tortor at auctor.
              </div>
            </div>
